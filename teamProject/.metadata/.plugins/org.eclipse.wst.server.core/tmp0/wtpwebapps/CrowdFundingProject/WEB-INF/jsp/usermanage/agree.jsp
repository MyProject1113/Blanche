				...
				$('#next1').click(function(e) {
					if($("input[name='con_user']:checked").val() == "Y") {
						 if($("input[name='con_per']:checked").val() == "Y"){
							 location.href="/usermanage/join.do";
						 }else{
		...
		<form>
			<table>
				...
				<tr>
					...
					<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1">[전문보기]</button>
					</td>
				</tr>
				<tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">개인정보 이용약관</h4>
      </div>
...
- 이용자가 전체 기업정보, 즐겨찾기 등록, 투자이력 열람 등의 회원제 기반으로 제공되는 서비스를 이용하고자 하는 경우에는 회원가입이 필요합니다.
  가. 수집하는 개인정보의 항목 
1) 회사는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 개인정보를 수집하고 있습니다.
- 필수항목 : 이메일 주소, 비밀번호
2) 회사는 회원가입한 이용자의 투자서비스 제공을 위해 실명확인 및 계좌등록 등을 진행하고 있으며, 아래와 같은 개인정보를 수집하고 있습니다.
- 소득요건확인 또는 전문투자자 확인시(이하 ‘투자자 확인’) 필수항목 : 소득요건구비투자자 확인서류(금융소득명세서, 근로소득원칭징수영수증 등) 또는 전문투자자 확인서류(전문자격증, 전문투자자 확인증 등)
- 실명확인시 필수항목
가) 자연인 : 성명, 휴대폰번호, 주소, 신분증 사본, 주민등록번호 
나) 법인 : 법인명, 사업자등록번호, 법인등록번호, 법인 담당자 전화번호, 주사무소 소재지, 법인등기부등본, 대표자 신분증 사본
  - 계좌등록시 필수항목 : 본인의 증권계좌번호, 증권사
  - 청약증거금 납입시 필수항목 : 은행, 계좌번호, 고유식별번호
  (미성년자의 경우 법정대리인의 실명확인증표, 가족관계서류등 별도 서류)
...
2. 개인정보의 수집 및 이용목적 
  ...
  - 컨텐츠 제공, 온라인소액투자서비스 제공, 특정 맞춤 서비스 제공, 실명확인, 청약증거금 결제
  나. 회원관리
  - 회원제 서비스 이용 및 제한적 본인 확인제에 따른 본인확인, 개인식별, 불량회원(회사 이용약관 제11조 제1항 각 호에 해당하는 위반사유로 인한 영구이용정지 및 제19조 제2항에 따라 계약해지된 영구이용정지 회원)의 부정 이용방지와 비인가 사용방지, 가입의사 확인, 가입 및 가입횟수 제한, 분쟁 조정을 위한 기록보존, 불만처리 등 민원처리, 고지사항 전달
...
3. 개인정보의 공유 및 제3자 제공 
회사는 이용자들의 개인정보를 "2. 개인정보의 수집및 이용목적"에서 고지한 범위내에서 사용하며, 이용자의 사전 동의 없이는 동 범위를 초과하여 이용하거나 이용자의 개인정보를 제3자에게 공개하지 않습니다. 다만, 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우, 그리고 다음 경우에는 예외로 합니다. 
1) 투자한도 확인
개인정보를 제공 받는 자 : 한국예탁결제원
제공하는 개인정보의 항목 : 투자자확인, 실명확인, 계좌등록 시 제공한 개인정보 일체
개인정보를 제공 받는 자의 개인정보 이용목적 : 투자한도 확인, 청약내역관리, 증권계좌 유효성 확인, 증권발행 및 배정내역관리
제공받은 개인정보의 이용기간 및 보유기간 : 10년

2) 청약증거금 납입
개인정보를 제공 받는 자 : 금융결제원
제공하는 개인정보의 항목 : 청약금납입시 제공한 개인정보 일체
개인정보를 제공 받는 자의 개인정보 이용목적 : 비대면 실명확인, 청약증거금 관리 및 납입
제공받은 개인정보의 이용기간 및 보유기간 : 청약증거금 납입시부터 이체 완료시까지
4. 개인정보의 취급위탁 
회사는 서비스 향상을 위해서 귀하의 개인정보를 외부에 위탁하여 처리할 수 있습니다. 
- 개인정보의 처리를 위탁하는 경우에는 미리 그 사실을 귀하에게 고지하고 동의를 받도록 하겠습니다. 
...
회사의 개인정보 위탁처리 기관 및 위탁업무 내용은 아래와 같습니다.
    ...
    - 데이터베이스 관리, 유지관리 서비스, 서비스의 운영을 위한 이메일 전송
    (수탁업체: Google Analytics) 
    - 서비스의 운영을 위한 데이터 애널리틱스 및 데이터 처리
5. 개인정보의 보유 및 이용기간 
1) 이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용목적이 달성되면 지체 없이 파기합니다. 다만, 상법, 자본시장과 금융투자에 관한 법률, 전자금융거래법, 특정 금융거래정보의 보고 및 이용에 관한 법률 등 관련법규상의 의무이행 및 금융감독원 기타 감독기관의 요청·명령에 따른 제출할 의무이행에 필요할 것으로 판단되는 정보에 대해서는 개인정보를 파기하지 아니하고 보유할 수 있습니다. 
2) 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.
    - 부정이용기록
     보존 이유 : 부정 이용 방지
     보존 기간 : 1년
    - 투자자확인, 실명확인 및 계좌등록에 관한 기록
     보존 이유 : 정보통신망 이용촉진 및 정보보호 등에 관한 법률
     보존 기간 : 1년(다만, 실명확인을 위한 이미지 파일은 확인 후 즉시 삭제함)
    - 전자금융거래의 종류 및 금액, 전자금융거래의 상대방에 관한 정보, 거래일시 등 전자금융기록
     보존 이유 : 전자금융거래법
     보존 기간 : 5년(다만, 건당 1만원 이하인 전자금융거래에 관한 기록은 1년간 보존)
    - 방문에 관한 기록
     보존 이유 : 통신비밀보호법
     보존 기간 : 3개월
6. 개인정보 파기절차 및 방법 
...
7. 이용자 및 법정대리인의 권리와 그 행사방법 
    ...
    - 이용자 혹은 당해 만 14세 미만 아동의 개인정보 조회, 수정을 위해서는 '개인정보변경'(또는 '회원정보수정' 등)을, 가입해지(동의철회)를 위해서는 "회원탈퇴"를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 
    - 문의사항은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체 없이 조치하겠습니다. 
...
회사는 개인화되고 맞춤화된 서비스를 제공하기 위해서 이용자의 정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버가 이용자의 브라우저에게 보내는 아주 작은 텍스트 파일로 이용자 컴퓨터의 하드디스크에 저장됩니다.  
  ...
  가. 쿠키의 사용 목적
  - 이용자들의 로그인 및 최근접속기록을 토대로 유저간 상호 커뮤니케이션 시의 편리한 기능을 제공하기 위하여 활용됩니다.
  나. 쿠키의 설치/운영 및 거부
...
제1조 (목적) 
이 약관은 주식회사 인크(이하 “회사”)가 온라인으로 제공하는 서비스 및 이에 부수된 제 반 서비스(이하 “서비스”)의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다. 

제 2 조 (용어의 정의) 
① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다. 
1. “회사”라 함은 온라인을 통하여 서비스를 제공하는 사업자를 의미합니다.
2. “회원”이라 함은 회사의 서비스에 접속하여 이 약관에 따라 회사와 이용계약을 체결하여 회사가 제공하는 서비스를 이용하는 고객을 의미합니다.
3. “서비스”라 함은 회사가 회원에게 온라인으로 제공하는 온라인소액투자중개 서비스 및 이에 부수된 제반 서비스를 의미합니다.
4. “계정(ID)”이라 함은 회원의 식별과 서비스 이용을 위하여 회원이 선정하고 회사가 부여하는 문자, 숫자 또는 특수문자의 조합을 의미합니다.
5. “계정정보“라 함은 회원의 계정, 비밀번호, 성명 등 회원이 회사에 제공한 일반정보 및 서비스이용정보, 이용요금 결제상태 등 생성 정보를 통칭합니다.
6. “비밀번호”라 함은 회원이 부여 받은 계정과 일치되는 회원임을 확인하고 회원의 정보 및 권익보호를 위해 회원 자신이 선정하여 는 문자, 숫자 또는 특수문자의 조합을 의미합니다.
7. “콘텐츠”라 함은 회사가 서비스에 제공하는 문자, 문서, 그림, 음성, 음향, 영상 또는 이들의 조합으로 이루어진 모든 정보를 말합니다.
8. “게시물”이라 함은 회원이 서비스를 이용함에 있어 회원이 게시한 문자, 문서, 그림, 음성, 영상 또는 이들의 조합으로 이루어진 모든 정보를 말합니다.
② 이 약관에서 사용하는 용어의 정의는 제1항 각호에서 정하는 것을 제외하고는 관계법령 및 기타 일반적인 상관례에 의합니다.

제 3 조 (회사정보 등의 제공) 
회사는 다음 각 호의 사항을 서비스 초기화면이나 서비스 홈페이지에 게시하여, 회원이 이를 쉽게 알 수 있도록 합니다. 다만, 개인정보취급방침과 약관은 회원이 연결화면을 통하여 볼 수 있도록 할 수 있습니다. 
1. 상호 및 대표자의 성명
2. 영업소 소재지 주소(회원의 불만을 처리할 곳의 주소 포함) 및 전자우편주소
3. 전화번호
4. 사업자등록번호
5. 홈페이지 이용약관
6. 서비스 이용약관
...
제 4 조 (약관의 명시와 개정) 
① 회사는 이 약관의 내용을 회원이 알 수 있도록 서비스 초기 화면이나 서비스 홈페이지에 게시하거나 연결화면을 제공하는 방법으로 회원에게 공지합니다.
② 회사는 회원이 회사와 이 약관의 내용에 관하여 질의 및 응답을 할 수 있도록 조치를 취합니다.
③ 회사는 서비스를 이용하고자 하는 자(이하 “이용자”라 한다)가 약관의 내용을 알 수 있도록 작성하고 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중 청약철회, 과오납금의 환급, 계약 해제ㆍ해지, 회사의 면책사항 및 회원에 대한 피해보상 등 중요한 내용을 회원이 알 수 있도록 합니다.
④ 회사는 「전자상거래 등에서의 소비자보호에 관한 법률」, 「약관의 규제에 관한 법률」, 「정보통신망이용촉진 및 정보보호 등에 관한 법률」, 「콘텐츠산업진흥법」 등 관련 법령에 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.
⑤ 회사가 약관을 개정할 경우에는 적용일자 및 개정내용, 개정사유 등을 명시하여 그 적용일자로부터 최소한 7일 이전(단, 회원에게 불리하거나 중대한 사항의 변경은 30일 이전)부터 그 적용일자 경과 후 상당한 기간이 경과할 때까지 초기화면 또는 초기화면과의 연결화면을 통해 공지합니다. 기존회원에게는 공지 외에 개정약관을 전자우편주소로 발송합니다.
⑥ 회사가 약관을 개정할 경우에는 개정약관 공지 후 개정약관의 적용에 대한 회원의 동의 여부를 확인합니다. 개정약관 공지시 회원이 동의 또는 거부의 의사표시를 하지 않으면 승낙한 것으로 간주하겠다는 내용도 함께 공지한 경우에는 회원이 약관 시행일까지 거부의사를 표시하지 않는다면 개정약관에 동의한 것으로 간주할 수 있습니다.
⑦ 회원이 개정약관의 적용에 동의하지 않는 경우 회사 또는 회원은 서비스 이용계약을 해지할 수 있습니다.이때, 회사는 계약해지로 인하여 회원이 입은 손해를 배상합니다.

제 5 조 (약관 외 준칙) 
이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 「전자상거래 등에서의 소비자보호에 관한 법률」,「약관의 규제에 관한 법률」,「정보통신망이용촉진 및 정보보호 등에 관한 법률」,「콘텐츠산업진흥법」 등 관련 법령또는 상관례에 따릅니다. 
제 6 조 (운영정책) 
① 약관을 적용하기 위하여 필요한 사항과 회원의 권익을 보호하고 서비스 내 질서를 유지하기 위하여 회사는 약관에서 구체적 범위를 정하여 위임한 사항을 서비스 운영정책(이하 “운영정책”이라 합니다)으로 정할 수 있습니다.
② 회사는 운영정책의 내용을 회원이 알 수 있도록 서비스 초기 화면이나 서비스 홈페이지에 게시하거나 연결화면을 제공하는 방법으로 회원에게 공지하여야 합니다.
...
3. 운영정책의 내용이 약관에서 정한 내용과 근본적으로 다르지 않고 회원이 예측가능한 범위 내에서 운영정책을 개정하는 경우

제 2 장 이용계약의 체결 
제 7 조 (회원 계정(ID) 및 비밀번호) 
...
9. 외설 또는 폭력적인 말이나 글, 화상, 음향, 기타 공서양속에 반하는 정보를 (회사의 사이트에)공개 또는 게시하는 행위
10. 서비스 데이터를 유상으로 처분하거나 권리의 객체로 하는 행위
...
1. 회원의 계정명, 기타 서비스상 사용하는 명칭에 대한 제한
2. 댓글이용에 대한 제한
3. 서비스 이용방법에 대한 제한
4. 기타 회원의 서비스 이용에 대한 본질적 권리를 침해하지 않는 범위 내에서 회사가 서비스 운영상 필요하다고 인정되는 사항

제 4 장 서비스 이용 
제 12 조 (서비스의 변경 및 내용수정) 
① 회원은 회사가 제공하는 서비스를 이 약관, 운영정책 및 회사가 설정한 서비스규칙에 따라 이용할 수 있습니다.
② 회사는 서비스 내용의 제작, 변경, 유지, 보수에 관한 포괄적인 권한을 가집니다.
③ 회사가 상당한 이유가 있는 경우에 운영상, 기술상의 필요에 따라 서비스 수정을 할 수 있으며, 서비스 수정을 하는 경우에는 변경 후 해당 서비스 화면 등을 통하여 공지합니다.

제 13 조 (서비스의 제공 및 중단 등) 
① 회사는 영업방침에 따라 정해진 시간 동안 서비스를 제공합니다.
② 제1항에도 불구하고, 다음 각 호의 어느 하나에 해당하는 경우에는 일정한 시간동안 서비스가 제공되지 아니할 수 있으며, 해당 시간 동안 회사는 서비스를 제공할 의무가 없습니다.
1. 컴퓨터 등 정보통신설비의 보수점검, 교체, 정기점검 또는 서비스 내용이나 서비스의 수정을 위하여 필요한 경우
...
③ 회사는 제2항 제1호의 경우, 매주 또는 격주 단위로 일정 시간을 정하여 서비스를 중지할 수 있습니다. 이 경우 회사는 최소한 24시간 전에 그 사실을 회원에게 서비스 초기 화면이나 서비스 홈페이지에 고지합니다.
④ 제2항 제2호의 경우, 회사는 사전 고지 없이 서비스를 일시 중지할 수 있습니다. 회사는 이러한 경우 그 사실을 서비스 초기 화면이나 서비스 홈페이지에 사후 고지할 수 있습니다.
⑤ 회사는 회사가 제공하는 무료서비스 이용과 관련하여 이용자에게 발생한 어떠한 손해에 대해서도 책임을 지지 않습니다. 다만, 회사의 고의 또는 중대한 과실로 인하여 발생한 손해의 경우는 제외합니다.
⑥ 제2항 제3호 내지 제5호의 경우에 회사는 기술상•운영상 필요에 의해 서비스 전부를 중단할 수 있으며, 사전에 공지하고 서비스의 제공을 중단할 수 있습니다. 사전에 공지할 수 없는 부득이한 사정이 있는 경우는 사후에 공지를 할 수 있습니다.
⑦ 회사가 부득이한 사유에 따라 서비스를 종료하는 경우 회원은 서비스 이용이 중단됨에 따른 손해배상을 청구할 수 없습니다.

제 14 조 (정보의 수집 등) 
① 회사는 서비스 내에서 회원간에 이루어지는 모든 게시 내용을 저장ㆍ보관할 수 있습니다. 회사는 회원간의 분쟁 조정, 민원 처리 또는 서비스 질서의 유지를 위하여 회사가 필요하다고 판단하는 경우에 한하여 본 정보를 열람하도록 할 것이며, 본 정보는 회사만이 보유하고 법령으로 권한을 부여 받지 아니한 제3자는 절대로 열람할 수 없습니다. 회사는 해당 정보를 열람하기 전에 게시내용의 열람이 필요한 사유 및 열람 범위를 개인에게 사전 고지하기로 합니다. 다만, 계정도용, 현금거래, 언어폭력, 서비스 내 사기 등 기망행위, 버그 악용, 기타 현행 법령 위반행위 및 이 약관 제11조에서 정하는 중대한 약관위반 행위의 조사, 처리, 확인 및 이의 구제와 관련하여 회원의 게시 정보를 열람해야 할 필요가 있는 경우에는, 사후에 게시정보가 열람된 개인들에 대하여 열람한 사유와 열람한 정보 중 본인과 관련된 부분을 고지하기로 합니다.
② 회사는 서비스 운영 및 프로그램 안정화 등 서비스 품질 개선을 위하여 회원 PC 등 단말기 설정 및 사양 정보를 수집·활용할 수 있습니다.

제 15 조 (저작권 등의 귀속) 
① 서비스 내 회사가 제공하는 모든 콘텐츠에 대한 저작권 기타 지적재산권은 회사의 소유입니다.
...
③ 회원은 서비스내에서 보여지거나 서비스와 관련하여 회원 또는 다른 이용자가 서비스 클라이언트 또는 서비스를 통해 업로드 또는 전송하는 문자, 이미지, 사운드 및 모든 자료 및 정보(이하 '이용자 콘텐츠'라 한다.)에 대하여 회사가 다음과 같은 방법과 조건으로 이용하는 것을 허락합니다.
...
④ 서비스내에서 보여지지 않고 서비스와 일체화되지 않은 회원의 이용자 콘텐츠(예컨대, 일반게시판 등에의 게시물)에 대하여 회사는 회원의 명시적인 동의가 없이 상업적으로 이용하지 않으며, 회원은 언제든지 이러한 이용자 콘텐츠를 삭제할 수 있습니다.
⑤ 회사는 회원이 게시하거나 등록하는 서비스 내의 게시물, 게시 내용에 대해 제 11조에서 규정하는 금지행위에 해당된다고 판단되는 경우, 사전통지 없이 이를 삭제하거나 이동 또는 등록을 거부할 수 있습니다.
⑥ 제3항은 회사가 서비스를 운영하는 동안 유효하며 회원탈퇴 후에도 지속적으로 적용됩니다.

제 5 장 계약 해제·해지 및 이용제한 
제 16 조 (회사의 해제 및 해지) 
...
제 17 조 (회원에 대한 서비스 이용제한) 
① 회사는 회원에게 다음 각 호의 구분에 따라 회원의 서비스 이용을 제한할 수 있습니다.
이용제한이 이루어지는 구체적인 회원의 의무위반 사유는 서비스의 운영정책에서 정하기로 합니다.
...
② 회원이 본 약관을 위반하거나 위법한 행위로 회사에 손해를 끼친 경우, 회원은 회사에 대하여 그 손해에 대하여 배상할 책임이 있습니다. 
...
② 회사는 회원 전체에게 통지를 하는 경우 서비스 초기화면에 게시하거나 팝업화면 등을 제시함으로써 제1항의 통지에 갈음할 수 있습니다.

제 22 조 (재판권 및 준거법) 
본 약관은 대한민국 법률에 따라 규율되고 해석되며, 회사와 회원간에 발생한 분쟁으로 소송이 제기되는 경우, 법령에 정한 절차에 따른 법원을 관할 법원으로 합니다.

부칙 
제1조 이 약관은 2015년 12월 1일부터 적용됩니다.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
