package com.blanche.board.mypage.controller;
...
public class BoardMypageController implements Constant{
	private static Logger logger = Logger.getLogger(BoardMypageController.class);
	...
	public ModelAndView boardList(HttpServletRequest request) {
		...
		if (userData != null) {
			...
			mav.setViewName("board/mypage/listForm");
		} else {
	...
	public ModelAndView boardDetail(@ModelAttribute BoardMainVO param, HttpServletRequest request) {
		...
		if (boardData != null) {
			...
			mav.setViewName("board/mypage/detailForm");
		} else {
