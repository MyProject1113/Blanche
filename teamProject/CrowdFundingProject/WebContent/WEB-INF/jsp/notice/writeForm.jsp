			...
			<table class="boardTable">
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="checkbox" name="important" id="important" /><label for="important">공지사항 최상단에 표시</label></td>
					</tr>
					<tr>
						<td class="columnName center">제목</td>
						<td><input type="text" name="nt_title" id="nt_title" maxlength="40" /></td>
					</tr>
					<tr>
						<td class="columnName center">내용</td>
						<td><textarea name="nt_content" id="nt_content"></textarea></td>
					</tr>
					<tr>
